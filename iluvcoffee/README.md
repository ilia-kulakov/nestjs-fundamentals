...
1. Create migration file `npx typeorm migration:create src/migrations/CoffeeRefactor` and modify it manually
2. Run migration `npx typeorm migration:run -d ./ormconfig.js`
3. Revert migration `npx typeorm migration:revert -d ./ormconfig.js`
4. Generate migration file base on diffrence between DB and entities `npx typeorm migration:generate src/migrations/SchemaSync -d ./ormconfig.js`
